...
#define GROUPED_INFER_HEADDIM_SWITCH(HEAD_DIM1, HEAD_DIM2, ...)         \
  ...
  using DeviceOpInstanceTemp = ck::tensor_operation::device::DeviceGroupedMultiheadAttentionInfer_Xdl_CShuffle<
          ...
          kGemm1NXdlPerWave,
          GemmOpConstantsGroupedInfer::ABlockTransferThreadClusterLengths_AK0_M_AK1,
          ...
          GemmOpConstantsGroupedInfer::BBlockTransferThreadClusterLengths_BK0_N_BK1,
          ...
          GemmOpConstantsGroupedInfer::B1BlockTransferThreadClusterLengths_BK0_N_BK1,
    ...
    static void Run(GroupedForwardParams& param, hipStream_t stream)
    {
        ...
        constexpr ck::index_t thread_slice_length_ak1 =
            GemmOpConstantsGroupedInfer::AK1 /
            GemmOpConstantsGroupedInfer::ABlockTransferThreadClusterLengths_AK0_M_AK1::At(I2);
        constexpr ck::index_t thread_slice_length_bk1 =
            GemmOpConstantsGroupedInfer::BK1 /
            GemmOpConstantsGroupedInfer::BBlockTransferThreadClusterLengths_BK0_N_BK1::At(I2);
        ...
        GROUPED_INFER_HEADDIM_SWITCH(param.K, param.Kv, [&] {
            constexpr ck::index_t thread_slice_length_gemm1n =
                kGemm1NPerBlock /
                GemmOpConstantsGroupedInfer::B1BlockTransferThreadClusterLengths_BK0_N_BK1::At(I1);
    ...
    static void RunWithDeviceOp(GroupedForwardParams& param, hipStream_t stream)
    {
        ...
        auto arg_ptr = op.MakeArgumentPointer(param.q_ptrs,
                                              param.k_ptrs,
                                              param.v_ptrs,
                                              param.out_ptrs,
