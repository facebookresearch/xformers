...
fmha_cutlassF_f16_notaligned_64x64_rf_sm80(typename AttentionKernel<cutlass::half_t, cutlass::arch::Sm80, false, 64, 64, true, true, true>::Params p) {
  ...
  AttentionKernel<cutlass::half_t, cutlass::arch::Sm80, false, 64, 64, true, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: kernel `fmha_cutlassF_f16_notaligned_64x64_rf_sm80` is for sm80-sm90, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
fmha_cutlassF_f16_notaligned_32x128_rf_sm80(typename AttentionKernel<cutlass::half_t, cutlass::arch::Sm80, false, 32, 128, true, true, true>::Params p) {
  ...
  AttentionKernel<cutlass::half_t, cutlass::arch::Sm80, false, 32, 128, true, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: kernel `fmha_cutlassF_f16_notaligned_32x128_rf_sm80` is for sm80-sm90, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
fmha_cutlassF_f16_notaligned_32x128_gmem_sm80(typename AttentionKernel<cutlass::half_t, cutlass::arch::Sm80, false, 32, 128, false, true, true>::Params p) {
  ...
  AttentionKernel<cutlass::half_t, cutlass::arch::Sm80, false, 32, 128, false, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: kernel `fmha_cutlassF_f16_notaligned_32x128_gmem_sm80` is for sm80-sm90, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
