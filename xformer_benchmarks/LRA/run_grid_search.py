...
def grid_search(args):
    ...
    executor = submitit.AutoExecutor(folder=get_shared_folder() / "%j", slurm_max_num_timeout=30)
    ...
    for i, grid_data in enumerate(hyper_parameters):
        ...
        args.checkpoint_dir = os.path.join(orig_check_dir, f'{args.task}', 'logs', run_name)
