...
def build_dataloaders(args: argparse.Namespace, config_training: Dict):
    datasets = {}
...
def benchmark(args):
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename=logger._version,
        every_n_train_steps=config_training["eval_frequency"],
    )
    ckpt_path = os.path.join(args.checkpoint_dir, f"{logger._version}.ckpt")
