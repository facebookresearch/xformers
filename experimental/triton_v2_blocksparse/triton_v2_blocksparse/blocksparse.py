...
if _is_triton_available:
    ...
    @register_attention("blocksparsev2", BlockSparseAttentionConfig)
    class BlockSparseAttentionV2(Attention):
        r"""
        ...
        .. warning: the block size has to be picked from [16, 32, 64, 128]. Some speed is gained from bigger blocks.
