...
## [0.0.29.post2] - 2025-01-30
Pre-built binary wheels require PyTorch 2.6.0
Following PyTorch, we build wheels for CUDA 11.8, 12.4, and 12.6 only (we no longer build for CUDA 12.1).
