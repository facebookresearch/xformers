...
#define GROUPED_BACKWARD_V1_HEADDIM_SWITCH(HEAD_DIM1, HEAD_DIM2, ...)              \
  ...
  using DeviceOpInstanceTemp_V2 = ck::tensor_operation::device::DeviceGroupedMultiheadAttentionBackward_Qloop_Xdl_CShuffle_V2<
    ...
    static void Run(GroupedBackwardParams& param, hipStream_t stream)
    {
        ...
        if(param.K <= 64 && param.Kv <= 64)
        {
            ...
            constexpr ck::index_t thread_slice_length_ak1 =
                GemmOpConstantsGroupedBackward_V1::AK1 /
                GemmOpConstantsGroupedBackward_V1::ABlockTransferThreadClusterLengths_AK0_M_AK1::At(
                    I2);
            constexpr ck::index_t thread_slice_length_bk1 =
                GemmOpConstantsGroupedBackward_V1::BK1 /
                GemmOpConstantsGroupedBackward_V1::BBlockTransferThreadClusterLengths_BK0_N_BK1::At(
                    I2);
        ...
        else
        {
            ...
            constexpr ck::index_t thread_slice_length_ak1 =
                GemmOpConstantsGroupedBackward_V2::AK1 /
                GemmOpConstantsGroupedBackward_V2::ABlockTransferThreadClusterLengths_AK0_M_AK1::At(
                    I2);
            constexpr ck::index_t thread_slice_length_bk1 =
                GemmOpConstantsGroupedBackward_V2::BK1 /
                GemmOpConstantsGroupedBackward_V2::BBlockTransferThreadClusterLengths_BK0_N_BK1::At(
                    I2);
    ...
    static void RunWithDeviceOp(GroupedBackwardParams& param, hipStream_t stream)
    {
        // Tunables
        ...
        for(std::size_t i = 0; i < param.num_batches; i++)
        {
            ...
            std::vector<ck::index_t> kgrad_gs_ns_ks_strides = {0,
            ...
            std::vector<ck::index_t> vgrad_gs_os_ns_strides = {0,
...
template <typename scalar_t, int32_t custom_mask_type, bool has_attn_bias, bool use_fp32_qkv_grad>
void run_grouped_backward_masktype_attnbias_dispatched(GroupedBackwardParams& param,
                                                       hipStream_t stream)
{
    grouped_backward_masktype_attnbias_dispatched<scalar_t,
                                                  custom_mask_type,
                                                  has_attn_bias,
