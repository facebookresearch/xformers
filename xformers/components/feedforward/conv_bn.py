...
@dataclass
class ConvBNConfig(FeedforwardConfig):
...
@register_feedforward("ConvBN", ConvBNConfig)
class ConvBN(Feedforward):
    """
    A 2D Convolutional + BN feed-forward network, as proposed in EfficientFormer_ (Vision Attention Network, Guo et al.)

    .. _EfficientFormer: https://arxiv.org/pdf/2206.01191.pdf
    """
