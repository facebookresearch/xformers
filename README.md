...
![Memory use for different attentions](docs/plots/memory_vs_attention.png)

![Runtime for different attentions](docs/plots/runtime_vs_attention.png)
...
| **matmul_with_mask**   | B=8, M=256, K=128 | B=8, M=1024, K=256 |
| ---------------------- | ----------------- | ------------------ |
| dense                  | 62.3              | 510.3              |
...
| **softmax**            | B=8, M=256, K=128 | B=8, M=1024, K=256 |
| ---------------------- | ----------------- | ------------------ |
| dense                  | 12.8              | 141.9              |
...
| **bmm**                | B=8, M=256, K=128 | B=8, M=1024, K=256 |
| ---------------------- | ----------------- | ------------------ |
| dense                  | 31.0              | 590.7              |
...
| Favor-256 (redraw)          | 18.75     | **63.53** | **79.37** | 32.44     | 66.77      | 52.17     | 0.49          | 445             |
...
| Lambda                      | 19.76     | 62.47     | 79.11     | 35.04     | 49.74      | 49.74     | x             | 1023            |
