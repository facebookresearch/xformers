...
fmha_cutlassF_f32_aligned_64x64_rf_sm50(typename AttentionKernel<float, cutlass::arch::Sm50, true, 64, 64, true, true, true>::Params p) {
  ...
  AttentionKernel<float, cutlass::arch::Sm50, true, 64, 64, true, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
...
fmha_cutlassF_f32_aligned_64x64_rf_sm70(typename AttentionKernel<float, cutlass::arch::Sm70, true, 64, 64, true, true, true>::Params p) {
  ...
  AttentionKernel<float, cutlass::arch::Sm70, true, 64, 64, true, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
...
fmha_cutlassF_f32_aligned_64x64_rf_sm75(typename AttentionKernel<float, cutlass::arch::Sm75, true, 64, 64, true, true, true>::Params p) {
  ...
  AttentionKernel<float, cutlass::arch::Sm75, true, 64, 64, true, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
...
fmha_cutlassF_f32_aligned_64x64_rf_sm80(typename AttentionKernel<float, cutlass::arch::Sm80, true, 64, 64, true, true, true>::Params p) {
  ...
  AttentionKernel<float, cutlass::arch::Sm80, true, 64, 64, true, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: kernel `fmha_cutlassF_f32_aligned_64x64_rf_sm80` is for sm80-sm90, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
fmha_cutlassF_f32_aligned_32x128_rf_sm50(typename AttentionKernel<float, cutlass::arch::Sm50, true, 32, 128, true, true, true>::Params p) {
  ...
  AttentionKernel<float, cutlass::arch::Sm50, true, 32, 128, true, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
...
fmha_cutlassF_f32_aligned_32x128_rf_sm70(typename AttentionKernel<float, cutlass::arch::Sm70, true, 32, 128, true, true, true>::Params p) {
  ...
  AttentionKernel<float, cutlass::arch::Sm70, true, 32, 128, true, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
...
fmha_cutlassF_f32_aligned_32x128_rf_sm75(typename AttentionKernel<float, cutlass::arch::Sm75, true, 32, 128, true, true, true>::Params p) {
  ...
  AttentionKernel<float, cutlass::arch::Sm75, true, 32, 128, true, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
...
fmha_cutlassF_f32_aligned_32x128_rf_sm80(typename AttentionKernel<float, cutlass::arch::Sm80, true, 32, 128, true, true, true>::Params p) {
  ...
  AttentionKernel<float, cutlass::arch::Sm80, true, 32, 128, true, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: kernel `fmha_cutlassF_f32_aligned_32x128_rf_sm80` is for sm80-sm90, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
fmha_cutlassF_f32_aligned_32x128_gmem_sm50(typename AttentionKernel<float, cutlass::arch::Sm50, true, 32, 128, false, true, true>::Params p) {
  ...
  AttentionKernel<float, cutlass::arch::Sm50, true, 32, 128, false, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
...
fmha_cutlassF_f32_aligned_32x128_gmem_sm70(typename AttentionKernel<float, cutlass::arch::Sm70, true, 32, 128, false, true, true>::Params p) {
  ...
  AttentionKernel<float, cutlass::arch::Sm70, true, 32, 128, false, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
...
fmha_cutlassF_f32_aligned_32x128_gmem_sm75(typename AttentionKernel<float, cutlass::arch::Sm75, true, 32, 128, false, true, true>::Params p) {
  ...
  AttentionKernel<float, cutlass::arch::Sm75, true, 32, 128, false, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
...
fmha_cutlassF_f32_aligned_32x128_gmem_sm80(typename AttentionKernel<float, cutlass::arch::Sm80, true, 32, 128, false, true, true>::Params p) {
  ...
  AttentionKernel<float, cutlass::arch::Sm80, true, 32, 128, false, true, true>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: kernel `fmha_cutlassF_f32_aligned_32x128_gmem_sm80` is for sm80-sm90, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
