...
fmha_cutlassB_f32_aligned_k128_dropout_sm50(typename AttentionBackwardKernel<cutlass::arch::Sm50, float, true, true, 128>::Params p) {
  ...
  AttentionBackwardKernel<cutlass::arch::Sm50, float, true, true, 128>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: kernel `fmha_cutlassB_f32_aligned_k128_dropout_sm50` is for sm50-sm70, but was built for sm%d\n",
...
fmha_cutlassB_f32_aligned_k128_dropout_sm70(typename AttentionBackwardKernel<cutlass::arch::Sm70, float, true, true, 128>::Params p) {
  ...
  AttentionBackwardKernel<cutlass::arch::Sm70, float, true, true, 128>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: kernel `fmha_cutlassB_f32_aligned_k128_dropout_sm70` is for sm70-sm75, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
fmha_cutlassB_f32_aligned_k128_dropout_sm75(typename AttentionBackwardKernel<cutlass::arch::Sm75, float, true, true, 128>::Params p) {
  ...
  AttentionBackwardKernel<cutlass::arch::Sm75, float, true, true, 128>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: kernel `fmha_cutlassB_f32_aligned_k128_dropout_sm75` is for sm75-sm80, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
__global__ void __launch_bounds__(
...
fmha_cutlassB_f32_aligned_k128_dropout_sm80(typename AttentionBackwardKernel<cutlass::arch::Sm80, float, true, true, 128>::Params p) {
  ...
  AttentionBackwardKernel<cutlass::arch::Sm80, float, true, true, 128>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: kernel `fmha_cutlassB_f32_aligned_k128_dropout_sm80` is for sm80-sm90, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
