...
__global__ void __launch_bounds__(
    AttentionKernel<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 32, 128, 128, true, true>::kNumThreads,
    AttentionKernel<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 32, 128, 128, true, true>::kMinBlocksPerSm)
fmha_cutlassF_bf16_aligned_32x128_rf_sm80(typename AttentionKernel<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 32, 128, 128, true, true>::Params p);
__global__ void __launch_bounds__(
...
template <typename T> void dispatch_cutlassF_bf16_sm80(T cb, int cc) {
    ...
    cb(AttentionKernel<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 32, 128, 128, true, true>(), fmha_cutlassF_bf16_aligned_32x128_rf_sm80);
...
__global__ void __launch_bounds__(
    AttentionKernel<cutlass::half_t, cutlass::arch::Sm80, true, 32, 128, 128, true, true>::kNumThreads,
    AttentionKernel<cutlass::half_t, cutlass::arch::Sm80, true, 32, 128, 128, true, true>::kMinBlocksPerSm)
fmha_cutlassF_f16_aligned_32x128_rf_sm80(typename AttentionKernel<cutlass::half_t, cutlass::arch::Sm80, true, 32, 128, 128, true, true>::Params p);
__global__ void __launch_bounds__(
...
template <typename T> void dispatch_cutlassF_f16_sm80(T cb, int cc) {
    ...
    cb(AttentionKernel<cutlass::half_t, cutlass::arch::Sm80, true, 32, 128, 128, true, true>(), fmha_cutlassF_f16_aligned_32x128_rf_sm80);
...
__global__ void __launch_bounds__(
    AttentionKernel<float, cutlass::arch::Sm80, true, 32, 128, 128, true, true>::kNumThreads,
    AttentionKernel<float, cutlass::arch::Sm80, true, 32, 128, 128, true, true>::kMinBlocksPerSm)
fmha_cutlassF_f32_aligned_32x128_rf_sm80(typename AttentionKernel<float, cutlass::arch::Sm80, true, 32, 128, 128, true, true>::Params p);
__global__ void __launch_bounds__(
...
template <typename T> void dispatch_cutlassF_f32_sm80(T cb, int cc) {
    ...
    cb(AttentionKernel<float, cutlass::arch::Sm80, true, 32, 128, 128, true, true>(), fmha_cutlassF_f32_aligned_32x128_rf_sm80);
